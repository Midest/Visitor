 ...
 * [{@link #getDateFrom() дата начала}, {@link #getDateTo() дата конца}]
 * каждые {@link #duration сколько-то} {@link #unit временных единиц}.
 * Если есть указание временного периода [{@link #getStart() начало}, {@link #getEnd() конец}],
...
public class Periodical extends Interval {
     ...
     * единица времени для периода, возвращает <code>null</code>.
